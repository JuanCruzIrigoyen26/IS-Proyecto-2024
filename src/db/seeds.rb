...
Trivia.create(number: 1, title: 'CT',
...
Trivia.create(number: 2, title: 'Dropear',
...
Answer.create(number: 1, description: 'Comunidad Terrorista', correct: false,
              question_number: question_a1.number, test_letter: test_a.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'Ayudar a un compañero a subir a un lugar inalcanzable',
              correct: false, question_number: question_a2.number, test_letter: test_a.letter, game_number: game_1.number)
Answer.create(number: 2, description: 'Llegar rápido al site', correct: false,
              question_number: question_a2.number, test_letter: test_a.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'Cuando se hace una acción para engañar al contrincante',
              correct: true, question_number: question_a3.number, test_letter: test_a.letter, game_number: game_1.number)
Answer.create(number: 2, description: 'Cuando un jugador se asoma de forma rápida para tomar un angulo',
              correct: false, question_number: question_a3.number, test_letter: test_a.letter, game_number: game_1.number)
Answer.create(number: 3, description: 'Cuando todo el equipo se queda en un lugar', correct: false,
              question_number: question_a3.number, test_letter: test_a.letter, game_number: game_1.number)
Answer.create(number: 1, description: 'Eliminar a un enemigo', correct: true,
              question_number: question_a4.number, test_letter: test_a.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'Obstruir la visión o el paso de un compañero', correct: false,
              question_number: question_a5.number, test_letter: test_a.letter, game_number: game_1.number)
...
question_b4 = Question.create(number: 4, description: '¿Qué significa ronda cuchillo en CS2?',
                              test_letter: test_b.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'Una técnica para ver al enemigo a través de la pared',
              correct: false, question_number: question_b1.number, test_letter: test_b.letter, game_number: game_1.number)
Answer.create(number: 2, description: 'Disparar a través de las paredes', correct: true,
              question_number: question_b1.number, test_letter: test_b.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'Para ver sin ser visto', correct: true,
              question_number: question_b2.number, test_letter: test_b.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'No gastar dinero en la ronda', correct: true,
              question_number: question_b3.number, test_letter: test_b.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'Una ronda donde sólo se usan cuchillos', correct: true,
              question_number: question_b4.number, test_letter: test_b.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'Un rol que se encarga de ser el primero en entrar a un site',
              correct: true, question_number: question_c1.number, test_letter: test_c.letter, game_number: game_1.number)
Answer.create(number: 2, description: 'Una técnica para lanzar granadas de entrada', correct: false,
              question_number: question_c1.number, test_letter: test_c.letter, game_number: game_1.number)
Answer.create(number: 3, description: 'Una forma de limpiar angulos cuando se hace un rush',
              correct: false, question_number: question_c1.number, test_letter: test_c.letter, game_number: game_1.number)
Answer.create(number: 1, description: 'Descontar enemigos de manera solitaria', correct: false,
              question_number: question_c2.number, test_letter: test_c.letter, game_number: game_1.number)
...
Answer.create(number: 3, description: 'Obtener información de los contrincantes para informar a tu equipo',
              correct: true, question_number: question_c2.number, test_letter: test_c.letter, game_number: game_1.number)
Answer.create(number: 1, description: 'Ahorrar el dinero con el equipo y comprar poco equipamiento',
              correct: true, question_number: question_c3.number, test_letter: test_c.letter, game_number: game_1.number)
Answer.create(number: 2, description: 'Comprar equipamiento con todo el dinero', correct: false,
              question_number: question_c3.number, test_letter: test_c.letter, game_number: game_1.number)
Answer.create(number: 3, description: 'Ahorrar el dinero con el equipo y no comprar equipamiento',
              correct: false, question_number: question_c3.number, test_letter: test_c.letter, game_number: game_1.number)
Answer.create(number: 1, description: 'Un AWP para cada jugador y un chaleco', correct: false,
              question_number: question_c4.number, test_letter: test_c.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'Cuando disparas mientras estas saltando', correct: false,
              question_number: question_c5.number, test_letter: test_c.letter, game_number: game_1.number)
...
Trivia.create(number: 1, title: 'Site',
...
Answer.create(number: 1, description: 'En el site', correct: true, question_number: question_f1.number,
              test_letter: test_f.letter, game_number: game_1.number)
Answer.create(number: 2, description: 'En cualquier parte del mapa', correct: false,
              question_number: question_f1.number, test_letter: test_f.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'Tipo de francotirador', correct: false,
              question_number: question_f2.number, test_letter: test_f.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'Una pistola y granadas', correct: true,
              question_number: question_f3.number, test_letter: test_f.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'Volver a tener el control de un Site', correct: false,
              question_number: question_f4.number, test_letter: test_f.letter, game_number: game_1.number)
...
Answer.create(number: 1, description: 'Obtener información del enemigo usando el sonido', correct: false,
              question_number: question_f5.number, test_letter: test_f.letter, game_number: game_1.number)
...
Trivia.create(number: 1, title: 'Poke',
...
question_d3 = Question.create(number: 3, description: '¿Que se necesita para hacer un Confirm?',
                              test_letter: test_sf.letter, game_number: game_2.number)
...
Answer.create(number: 1, description: 'Estrategia para jugar', correct: false,
              question_number: question_d2.number, test_letter: test_sf.letter, game_number: game_2.number)
...
Answer.create(number: 1, description: 'Buena reacción ', correct: true,
              question_number: question_d3.number, test_letter: test_sf.letter, game_number: game_2.number)
...
Answer.create(number: 3, description: 'Para iniciar un Combo', correct: false,
              question_number: question_d4.number, test_letter: test_sf.letter, game_number: game_2.number)
Answer.create(number: 1, description: 'Un ataque que tienen todos los personajes', correct: false,
              question_number: question_d5.number, test_letter: test_sf.letter, game_number: game_2.number)
...
Answer.create(number: 1, description: 'Con un Target Comob', correct: false,
              question_number: question_t1.number, test_letter: test_t.letter, game_number: game_2.number)
...
Answer.create(number: 1, description: 'Una secuencia de ataques especiales', correct: false,
              question_number: question_t2.number, test_letter: test_t.letter, game_number: game_2.number)
...
Answer.create(number: 3, description: 'Una forma de ofensiva con ataques normales y agarres',
              correct: true, question_number: question_t2.number, test_letter: test_t.letter, game_number: game_2.number)
Answer.create(number: 1, description: 'Cuando estamos en Positivo', correct: false,
              question_number: question_t3.number, test_letter: test_t.letter, game_number: game_2.number)
Answer.create(number: 2, description: 'Cuando tenemos un movimiento rápido con Frames de ventaja',
              correct: true, question_number: question_t3.number, test_letter: test_t.letter, game_number: game_2.number)
...
Answer.create(number: 1, description: 'En el Corner/Esquina', correct: true,
              question_number: question_t4.number, test_letter: test_t.letter, game_number: game_2.number)
...
Answer.create(number: 1, description: 'Para saltar al lado opuesto del rival', correct: false,
              question_number: question_t5.number, test_letter: test_t.letter, game_number: game_2.number)
...
Answer.create(number: 1, description: 'Para defenderse', correct: false,
              question_number: question_u1.number, test_letter: test_u.letter, game_number: game_2.number)
...
Answer.create(number: 1, description: 'Para evitar un golpe', correct: false,
              question_number: question_u2.number, test_letter: test_u.letter, game_number: game_2.number)
...
Answer.create(number: 1, description: 'En el último frame de Wake Up del rival', correct: false,
              question_number: question_u3.number, test_letter: test_u.letter, game_number: game_2.number)
...
Answer.create(number: 1, description: 'Cuando podemos presionar mientras el rival se levanta',
              correct: true, question_number: question_u4.number, test_letter: test_u.letter, game_number: game_2.number)
Answer.create(number: 2, description: 'Cuando queremos responder en Wake Up', correct: false,
              question_number: question_u4.number, test_letter: test_u.letter, game_number: game_2.number)
...
Answer.create(number: 1, description: 'Con ataques normales', correct: false,
              question_number: question_u5.number, test_letter: test_u.letter, game_number: game_2.number)
...
Trivia.create(number: 1, title: 'Buffer',
...
Trivia.create(number: 3, title: 'Shoto',
...
Trivia.create(number: 5, title: 'Techear',
...
question_y1 = Question.create(number: 1, description: '¿Con que ataques se hacen un Buffer?',
                              test_letter: test_y.letter, game_number: game_2.number)
...
Answer.create(number: 1, description: 'Ataques normales', correct: false,
              question_number: question_y1.number, test_letter: test_y.letter, game_number: game_2.number)
...
Answer.create(number: 3, description: 'Zonas bajas y altas', correct: true,
              question_number: question_y2.number, test_letter: test_y.letter, game_number: game_2.number)
Answer.create(number: 1, description: 'Ryu, Ken y Akuma', correct: true,
              question_number: question_y3.number, test_letter: test_y.letter, game_number: game_2.number)
...
Answer.create(number: 3, description: 'Rising Fist/RF', correct: false,
              question_number: question_y4.number, test_letter: test_y.letter, game_number: game_2.number)
...
Trivia.create(number: 1, title: 'ADC',
              description: 'Un ADC (o Attack Damage Carry) suele hacer referencia a la clase Tirador, un carry de largo alcance que va al carril inferior con un apoyo y juega en la retaguardia durante los combates. Algunos tiradores entran dentro de este término a pesar de que hacen el mismo daño mágico e incluso a veces más que el físico (piensa en Kaisa, Kogmaw, Varus en ataque, etc.). El término se utiliza a menudo indistintamente con el de carril inferior, que a veces puede ser una clase de mago que se convierte en un rol secundario. En estos casos, la gente suele referirse al carril inferior como APC (Ability Power Carry), lo que significa que un portador de daño mágico.', test_letter: test_l.letter, mode: 'beginner', game_number: game_3.number)
Trivia.create(number: 2, title: 'Gank',
              description: 'Movimiento (tradicionalmente de los junglas) por el que emboscan una línea junto al jugador de ese carril. Para el resto de posiciones se utiliza el término Roam.', test_letter: test_l.letter, mode: 'beginner', game_number: game_3.number)
Trivia.create(number: 3, title: 'Invade',
              description: 'Invasión a la jungla enemiga para acabar con los monstruos de la zona rival. También se refiere a una estrategia a nivel uno que consiste en ir a buscar a los campeones enemigos al campamento inicial del jungla rival.', test_letter: test_l.letter, mode: 'beginner', game_number: game_3.number)
Trivia.create(number: 4, title: 'Splitpush',
              description: 'Estrategia que consiste en empujar una línea separado del equipo mientras ellos ejercen presión en otra zona del mapa.', test_letter: test_l.letter, mode: 'beginner', game_number: game_3.number)
Trivia.create(number: 5, title: 'Aggro',
              description: 'Puede hacer referencia a un estilo de juego (agresivo) o a ser objetivo de ataques de monstruos, súbditos, campeones o torretas enemigas.', test_letter: test_l.letter, mode: 'beginner', game_number: game_3.number)

question_l1 = Question.create(number: 1, description: '¿Que tipo de daño realiza por lo general un ADC?',
                              test_letter: test_l.letter, game_number: game_3.number)
question_l2 = Question.create(number: 2, description: '¿En donde se realizan Ganks?', test_letter: test_l.letter,
                              game_number: game_3.number)
...
Answer.create(number: 2, description: 'En un objetivo ', correct: false,
              question_number: question_l2.number, test_letter: test_l.letter, game_number: game_3.number)
...
Answer.create(number: 1, description: 'Cuando se empuja una linea individualmente', correct: true,
              question_number: question_l4.number, test_letter: test_l.letter, game_number: game_3.number)
...
Answer.create(number: 2, description: 'Centrado en los objetivos', correct: false,
              question_number: question_l5.number, test_letter: test_l.letter, game_number: game_3.number)
...
Trivia.create(number: 1, title: 'Tower Dive',
...
Trivia.create(number: 2, title: 'Creeps',
...
Trivia.create(number: 3, title: 'Facechecking',
...
Trivia.create(number: 4, title: 'Backdoor',
              description: 'En inglés significa puerta trasera. Hace referencia a una forma de acabar la partida que consiste en asaltar la base enemiga (generalmente con el nexo al descubierto) sin que se percante hasta que sea demasiado tarde.', test_letter: test_k.letter, mode: 'casual', game_number: game_3.number)
Trivia.create(number: 5, title: 'Base Race',
              description: 'En inglés significa carrera de bases. Se utiliza para describir situaciones en las que los dos equipos han cedido su defensa e intentan acabar la partida a la vez, cada uno en un lado del mapa.', test_letter: test_k.letter, mode: 'casual', game_number: game_3.number)

question_k1 = Question.create(number: 1, description: '¿Con cuantos jugadores se hace un Tower Dive por lo menos?',
                              test_letter: test_k.letter, game_number: game_3.number)
...
Answer.create(number: 1, description: 'Cantidad de oro obtenido', correct: false,
              question_number: question_k2.number, test_letter: test_k.letter, game_number: game_3.number)
...
Answer.create(number: 1, description: 'En la jungla y arbustos', correct: true,
              question_number: question_k3.number, test_letter: test_k.letter, game_number: game_3.number)
...
Answer.create(number: 1, description: 'Asaltar la base enemiga y ganar la partida', correct: true,
              question_number: question_k4.number, test_letter: test_k.letter, game_number: game_3.number)
...
Answer.create(number: 1, description: 'Dejar los objetivos y farmear creeps ', correct: false,
              question_number: question_k5.number, test_letter: test_k.letter, game_number: game_3.number)
...
Trivia.create(number: 1, title: 'Lane Freeze',
              description: 'Es cuando un laner ralentiza el empuje de una oleada de minion influyendo en qué minions atacan a qué minions. Esto requiere atacar estratégicamente a los minions en último lugar (atacarlos solo en el último segundo para conseguir oro), de modo que puedas mantener al laner enemigo atrapado en una posición. Esto sirve tanto para poner al laner enemigo en posición de una posible emboscada aliada como para mantenerlo fuera del alcance de los XP y el oro de los minions asesinos.', test_letter: test_j.letter, mode: 'professional', game_number: game_3.number)
Trivia.create(number: 2, title: 'Blind Pick',
              description: 'Esto significa elegir un campeón antes de que lo haga el laner enemigo. Esto puede ser muy malo si el enemigo elige un rival para tu campeón, por lo que la ‘elección a ciegas’ suele considerarse arriesgada a menos que el campeón que elijas sea increíblemente OP. Blind pick también puede ser útil cuando se elige una fuerte elección flexible, forzando al enemigo a elegir un counter que puede ser útil o no, o dejando impune una elección blind pick poderosa.', test_letter: test_j.letter, mode: 'professional', game_number: game_3.number)
Trivia.create(number: 3, title: 'Spacing',
              description: 'Movimiento con el que mantenemos distancias con el enemigo (de forma ofensiva u defensiva) de forma que podamos golpear a máximo rango minimizando la oportunidad de recibir daño y maximizando nuestra eficacia.', test_letter: test_j.letter, mode: 'professional', game_number: game_3.number)
Trivia.create(number: 4, title: 'Macrogame',
              description: 'Conjunto de estrategias que depende de todos los jugadores y suele implicar el juego entorno a objetivos', test_letter: test_j.letter, mode: 'professional', game_number: game_3.number)
Trivia.create(number: 5, title: 'Pathing',
              description: 'Camino seguido por un determinado campeón a lo largo de la partida. Se utiliza principalmente para hablar de las rutas que siguen los jugadores en la jungla (orden de campamentos, emboscadas, etc)', test_letter: test_j.letter, mode: 'professional', game_number: game_3.number)

question_j1 = Question.create(number: 1, description: '¿Que tipo de enemigos se ralentizan en un Lane Freeze?',
                              test_letter: test_j.letter, game_number: game_3.number)
...
Answer.create(number: 1, description: 'Mantener la distancia con el enemigo', correct: true,
              question_number: question_j3.number, test_letter: test_j.letter, game_number: game_3.number)
...
Answer.create(number: 1, description: 'Conjunto de estrategias con relación a objetivos', correct: true,
              question_number: question_j4.number, test_letter: test_j.letter, game_number: game_3.number)
...
Answer.create(number: 1, description: 'Camino seguido por el equipo', correct: false,
              question_number: question_j5.number, test_letter: test_j.letter, game_number: game_3.number)
...
Trivia.create(number: 2, title: 'Gank',
              description: 'Movimiento (tradicionalmente de los junglas) por el que emboscan una línea junto al jugador de ese carril. Para el resto de posiciones se utiliza el término Roam.', test_letter: test_h.letter, mode: 'FinalExam', game_number: game_3.number)
Trivia.create(number: 3, title: 'ADC',
              description: 'Un ADC (o Attack Damage Carry) suele hacer referencia a la clase Tirador, un carry de largo alcance que va al carril inferior con un apoyo y juega en la retaguardia durante los combates. Algunos tiradores entran dentro de este término a pesar de que hacen el mismo daño mágico e incluso a veces más que el físico (piensa en Kaisa, Kogmaw, Varus en ataque, etc.). El término se utiliza a menudo indistintamente con el de carril inferior, que a veces puede ser una clase de mago que se convierte en un rol secundario. En estos casos, la gente suele referirse al carril inferior como APC (Ability Power Carry), lo que significa que un portador de daño mágico.', test_letter: test_h.letter, mode: 'FinalExam', game_number: game_3.number)
Trivia.create(number: 4, title: 'Splitpush',
              description: 'Estrategia que consiste en empujar una línea separado del equipo mientras ellos ejercen presión en otra zona del mapa.', test_letter: test_h.letter, mode: 'FinalExam', game_number: game_3.number)
Trivia.create(number: 5, title: 'Backdoor',
              description: 'En inglés significa puerta trasera. Hace referencia a una forma de acabar la partida que consiste en asaltar la base enemiga (generalmente con el nexo al descubierto) sin que se percante hasta que sea demasiado tarde.', test_letter: test_h.letter, mode: 'FinalExam', game_number: game_3.number)

question_h1 = Question.create(number: 1, description: '¿A que tipo de Creeps se les hace Lane Freeze?',
                              test_letter: test_h.letter, game_number: game_3.number)
